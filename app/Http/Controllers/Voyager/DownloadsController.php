...
class DownloadsController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
       ...
       /*$download = Download::find($id);
        $allProductsAssociated = $download->products()->get();*/
    ...
    public function edit(Request $request, $id)
    {
        ...
        $allProductsAssociated = $download->products()->get();
        $allProducts = Product::all();
      /*  $downloadsForProduct  = DB::table('download_product')->join('products','download_product.product_id','=' ,'products.id')
        ->get();*/
      
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','download','allProductsAssociated','allProducts'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DownloadProduct::where('download_id',$id)->delete();
        //Download::where('id',$id)->delete();
        if($request->product){
            //Download::where('id',$id)->update(['active' => '0']);
    ...
    public function create(Request $request)
    {
        ...
        $allProducts = Product::all();
        $allProductsAssociated = collect([]);

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable'
        ,'allProducts','allProductsAssociated'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->product){
            foreach($request->product as $product){
                if((DownloadProduct::find($product) || DownloadProduct::find($data->id))  == false){
                    DownloadProduct::create([
                        'download_id' => $data->id,
                        'product_id' => $product, 
                        'active' => 1,
